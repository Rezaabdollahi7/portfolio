...
const FreelancerWork = () => {
    return (
        <section id="freelancer" className="lg:w-[90%]  rounded-tr-9xl lg:rounded-br-9xl px-8 lg:px-28 py-12 -mb-[19%] relative  z-40  bg-pattern-2 bg-center bg-cover bg-blend-multiply bg-blue-700 grid grid-cols-1   lg:grid-cols-2 gap-10  lg:gap-10 items-center  justify-center " >
            {/* text section */}
            <div className="freeTxt order-1  ">
                ...
                <p className="mt-4 text-xl  text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
