...
const AboutMe = () => {
    ...
    return (
        <section className='w-full bg-aboutMe rounded-3xl mt-[25%]  lg:mt-[6.5%] lg:pt-16 '>
            <main id='aboutMain'  className='w-[85%] p-[3%]  mx-auto gap-32 mt-4  flex flex-col lg:flex-row  items-start justify-center lg:rounded-3xl '>
                <div className="prof-container lg:w-1/2 mt-12">
                    <img className='rounded-2xl' src="./images/prof-img.jpg" alt="prof-img" />
                </div>
                ...
                <div className="prof-text-wrapper lg:w-1/2 -mt-12  lg:mt-12">
                    ...
                    <h1 className='mt-4 lg:mt-8 text-[2.5rem]  lg:text-[4rem] font-bold uppercase text-white'>Alycia <span className='text-blue-700 font-semibold '>Carey</span> </h1>
                    <h3 className='mt-4 text-2xl relative font-semibold text-white' >UI/UX Designer</h3>
                    <ul className='mt-8'>
