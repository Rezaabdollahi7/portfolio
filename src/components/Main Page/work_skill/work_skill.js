        ...
        <section className="skil-all-wrapper w-full bg-skill rounded-bl-7xl ">
            <section className="work-skill-wrap  mx-auto grid lg:grid-cols-2 gap-5">
                ...
                <section className='left-side col-span-1 bg-blend-multiply bg-pattern-2 bg-stone-800   -mt-24 mb-16 rounded-tr-6xl rounded-br-6xl px-8  lg:px-16'>
                    <h3 className=' text-4xl lg:text-5xl text-white font-bold w-full mt-24'> My Work &<span className='f-conveat'> Experience</span></h3>
                    ...
                    <div className="work-exp-item-wrapper flex flex-col  ">
                        {/* item 1 */}
                        <div className="exp-item flex items-center justify-between my-12  lg:mt-16 lg:mb-0 rounded-5xl lg:p-12 ">
                            ...
                            <div className="item-text ml-4  lg:ml-2  ">
                                ...
                                <p className='mt-4  lg:text-xl font-semibold text-favblue-50 ' >Incident Software House</p>
                            </div>
                        ...
                        <div className="exp-item flex items-center justify-between  lg:mt-8 bg-favblue-50 bg-blend-multiply bg-pattern-2 bg-center bg-cover  rounded-5xl px-8  lg:p-12 ">
                            ...
                            <div className="item-text ml-4 my-4  lg:ml-4  ">
                                ...
                                <h5 className='uppercase lg:text-3xl text-white mt-4 font-bold '> ui/ux creative design </h5>
                                <p className='mt-4 text-white  lg:text-xl font-semibold ' >Incident Software House</p>
                ...
                {/* right side */}
                <section className="rigt-side col-span-1 mb-8  mt-12 lg:mb-8  lg:mt-32 mx-auto  w-[90%] ">
                    ...
                    <section className="skill-item-wrapper w-full grid grid-cols-1 lg:grid-cols-2 mt-8 gap-7 " >
                        ...
                        <div className="skill-item bg-pattern-2 bg-center bg-cover rounded-7xl border-6 border-gray-200 p-10  ">
                            ...
                            <p className='mt-5 text-lg text-gray-400'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
