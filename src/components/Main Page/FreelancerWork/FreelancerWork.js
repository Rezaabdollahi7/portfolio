    ...
    return (
        <section id="freelancer" className="w-[95%]  lg:w-[90%]  rounded-tr-9xl rounded-br-9xl px-8 lg:px-28 py-12 -mb-[75%]  lg:-mb-[19%] relative  z-40  bg-pattern-2 bg-center bg-cover bg-blend-multiply bg-blue-700 grid grid-cols-1   lg:grid-cols-2 gap-10  lg:gap-10 items-center  justify-center " >
            ...
            <div className="freeTxt order-1  ">
                <p className=" text-xl sm:text-xl  lg:text-2xl font-semibold text-white">I Am Available For</p>
                <h4 className="text-4xl  sm:text-5xl xl:text-6xl font-bold text-white mt-4 " >Freelance Work</h4>
                <p className="mt-4 lg:text-xl  text-gray-400">Empowering Independence, Crafting Success, and Pioneering the Future of Flexible Employment.</p>
