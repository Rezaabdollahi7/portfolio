    ...
    return(
        <section id="amazingWork" className="w-[92%] mx-auto ">
            <div className="tittle-wrap flex justify-center mt-32 items-center flex-col w-full">
                ...
                <p className="px-4 lg:px-0 text-lg  lg:text-xl text-center  mt-8 text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod <br />  tempor incididunt ut labore et dolore.</p>
            </div>
            {/* grid wrapper */}
            <div className="works-wrapper my-16 grid 800px:grid-cols-2  lg:grid-cols-4 gap-6 lg:grid-rows-7 lg:h-[50rem]">
            ...
            <div className="works-desc text-center mb-16 flex flex-col sm:flex-row justify-center items-center">
