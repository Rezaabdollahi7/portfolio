            ...
            <div className="item-wrap grid lg:grid-cols-3 gap-10 lg:w-[80%] mx-auto mt-16  ">
                ...
                <div className="item flex flex-col items-start justify-start  ">
                    ...
                    <div className="item-body flex flex-col items-start pl-16 justify-start bg-pattern-2 bg-center bg-cover  border-6 border-t-0  border-gray-200 rounded-b-2xl  w-full ">
                        <p className="text-6xl mt-8 text-favblue-100 font-bold"><span className="text-favblue-50 text-3xl "> $ </span>80.99</p>
                        <p className="mt-4 font-semibold  text-xl text-favblue-50">Monthly Package</p>
                        <ul className="mt-5">
                            <li className="text-lg text-gray-500 mt-2" >Web Development</li>
                            <li className="text-lg text-gray-500 mt-2" >Digital Marketing</li>
                            <li className="text-lg text-gray-500 mt-2" >Graphic Design</li>
                            <li className="text-lg text-gray-500 mt-2" >24/Support</li>
                        </ul>
                        <button className="my-12 px-12 py-4 bg-favblue-50 text-white font-bold text-lg rounded-xl hover:bg-white hover:text-favblue-50 border-2 border-transparent  hover:border-2 hover:border-favblue-50  transition-all duration-300 delay-75 ">CHOOSE NOW</button>
                    </div>
                </div>
